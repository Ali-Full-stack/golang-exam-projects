...
type HotelServiceClient interface {
	...
	GetAllHotels(ctx context.Context, in *HotelEmpty, opts ...grpc.CallOption) (HotelService_GetAllHotelsClient, error)
...
func (c *hotelServiceClient) GetAllHotels(ctx context.Context, in *HotelEmpty, opts ...grpc.CallOption) (HotelService_GetAllHotelsClient, error) {
...
type HotelServiceServer interface {
	...
	GetAllHotels(*HotelEmpty, HotelService_GetAllHotelsServer) error
...
func (UnimplementedHotelServiceServer) GetAllHotels(*HotelEmpty, HotelService_GetAllHotelsServer) error {
